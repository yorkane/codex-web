...
function readContextWindowFromConfig() {
    const configPaths = [
        node_path_1.default.join(node_os_1.default.homedir(), ".codex", "config.toml"),
        node_path_1.default.join(node_os_1.default.homedir(), ".config", "codex", "config.toml"),
    ];
...
function injectModelContextWindow(obj, contextWindow, visited = new WeakSet()) {
